...
/*
function checkCardImg(card) {
    return card.querySelector('.front-img').src;
}
*/
...
function calcScore() {
        ...
        document.querySelector('.dif-mlp').innerText = difMlp;
    
        //Display the score
        document.querySelectorAll('.score')[1].innerText = score;

        //Display time multiplier
        document.querySelector('.time-mlp').innerText = timeLeft;
        
        //Calculate final score and display it 
        score = (score * difMlp * timeLeft);
